...
#     glFlush()
#     glutSwapBuffers()  # Use double buffering for smoother updates
...
#     if key == b'q':
#         sys.exit(0)
#     elif key == b'e':  # Move forward
#         eye_z += 0.5
#         print(f"Moving forward, eye_z = {eye_z}")  # Debug print
#     elif key == b'd':  # Move backward
#         eye_z -= 0.5
#         print(f"Moving backward, eye_z = {eye_z}")  # Debug print
#     glutPostRedisplay()
