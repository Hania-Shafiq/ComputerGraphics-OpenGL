...
def draw_skeleton():
    ...
    for i in range(40):
        ...
        glVertex2f(0.0 + 0.3 * math.cos(theta), 1.3 + 0.3 * math.sin(theta))
    glEnd()
    ...
    draw_bone(0, 0, -0.7, 0)
    draw_joint(-0.7, 0)
    glRotatef(left_arm_angle / 2, 0, 0, 1)
    draw_bone(-0.7, 0, -1.2, 0)
    glPopMatrix()
    ...
    draw_bone(0, 0, 0.7, 0)
    draw_joint(0.7, 0)
    glRotatef(right_arm_angle / 2, 0, 0, 1)
    draw_bone(0.7, 0, 1.2, 0)
    glPopMatrix()
    ...
    draw_bone(0, 0, -0.3, -0.8)
    draw_joint(-0.3, -0.8)
    glRotatef(-left_leg_angle / 2, 0, 0, 1)
    draw_bone(-0.3, -0.8, -0.4, -1.5)
    glPopMatrix()
